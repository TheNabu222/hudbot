    ...
    try {
      const saved = localStorage.getItem('neocities_game_save_1');
      if (saved) {
    ...
    let saveGame = () => {
      localStorage.setItem('neocities_game_save_1', JSON.stringify(state));
    };
      ...
      document.querySelectorAll('.scene-object').forEach(obj => {
        ...
        obj.addEventListener('click', (e) => {
          ...
          try {
            ...
            const _logInteraction = obj.getAttribute('data-interaction');
            console.log('Interaction:', _logInteraction);
